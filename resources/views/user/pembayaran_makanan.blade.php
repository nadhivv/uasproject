    ...
    <section id="makanan" class="ftco-section ftco-menu bg-light">
        <div class="container-fluid px-md-4">
            ...
            <div class="card mb-4">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{ asset('storage/images/' . $orders->makanan->photo) }}" class="img-fluid rounded-start" alt="{{ $orders->makanan->nama_makanan }}">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">{{ $orders->makanan->nama_makanan }}</h5>
                            <p class="card-text">Total Harga: Rp {{ number_format($orders->price, 0, ',', '.') }}</p>

                            <form action="{{ route('pembayaran.proses', $orders->id) }}" method="POST">
                                @csrf
