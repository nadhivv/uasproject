        ...
        <div class="center-content">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5>Total Amount: Rp {{ number_format($booking->total_harga) }}</h5>
                    <button id="pay-button" class="btn btn-primary">Pay Now</button>
                    <a href="{{ route('penginapan.detail', $booking->penginapan->name) }}" class="btn btn-secondary">Kembali</a>
                    <pre id="result-json" style="margin-top: 10px; background: #f8f9fa; padding: 10px; border: 1px solid #dee2e6;"></pre>
                </div>
            </div>
        </div>
    </div>
